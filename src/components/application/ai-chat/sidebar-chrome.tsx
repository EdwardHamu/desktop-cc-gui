...
export function SidebarDragStrip({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <div
      ...
      className="chat-glass-surface relative flex h-10 w-full shrink-0 items-center justify-between gap-1 border-b border-separator-border bg-transparent px-3"
    >
